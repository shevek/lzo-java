...
public class LzopCodec extends LzoCodec {
	...
	public static class LzopInputStream extends BlockDecompressorStream {
		...
		private EnumMap<DChecksum, Integer> dcheck = new EnumMap<DChecksum, Integer>(DChecksum.class);
		private EnumMap<CChecksum, Integer> ccheck = new EnumMap<CChecksum, Integer>(CChecksum.class);
	...
	public static class LzopDecompressor extends LzoDecompressor {
		 ...
		 */
		private void initHeaderFlags(EnumSet<DChecksum> dflags,
		 ...
		 * decompressed data.
		 */
		private synchronized boolean verifyDChecksum(DChecksum typ, int checksum) {
		 ...
		 * compressed data.
		 */
		private synchronized boolean verifyCChecksum(CChecksum typ, int checksum) {

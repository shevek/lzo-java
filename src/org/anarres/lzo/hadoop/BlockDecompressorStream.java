...
public class BlockDecompressorStream extends DecompressorStream {
	private static final Log LOG = LogFactory.getLog(BlockDecompressorStream.class.getName());
 ...
 * @throws IOException
  ...
  protected int decompress(byte[] b, int off, int len) throws IOException {
    // Check if we are the beginning of a block
      LOG.info("Before: noUncompressedBytes=" + noUncompressedBytes + "; originalBlockSize=" + originalBlockSize);
    ...
    noUncompressedBytes += n;
      LOG.info("After: noUncompressedBytes=" + noUncompressedBytes + "; originalBlockSize=" + originalBlockSize);
